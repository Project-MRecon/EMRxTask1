...
from dataloading.generate_dataset import generate_train_val_ds, promptmr_test
join = os.path.join
...
def main(plans_args):
    ...
    train_ds, val_ds, plans_args = promptmr_test(plans_args)
...
if __name__ == '__main__':
    config = {
        "json_path": "/homes/ljchen/data/cmrecon_temp",
        "resume": None,  # "./saved/model/0807_1536/checkpoint-epoch48.pth"
        "epochs": 100,
        "save_dir": "./saved",
        'network': {"arch": "PromptMR",
                    "args": {"spatial_dims": 2,
                            "in_channels": 1,
                            "out_channels": 1,
